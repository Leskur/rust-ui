    ...
    Box::new(
        rust_ui::column![
            ...
            rust_ui::row![
                ...
                svg_card(
                    "https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/home.svg",
                    "home"
                ),
                svg_card(
            ...
            rust_ui::row![
                svg("https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/star.svg")
                    .width(16.0)
                    .height(16.0),
                svg("https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/star.svg")
                    .width(32.0)
