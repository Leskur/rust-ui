    ...
    Box::new(rust_ui::column![
        ...
        rust_ui::row![
            image("https://picsum.photos/seed/a/400/300")
                .width(180.0).height(120.0).fit(ObjectFit::Cover).radius(8.0),
        ...
        rust_ui::row![
            image("https://picsum.photos/seed/d/300/400")
                .width(120.0).height(160.0).fit(ObjectFit::Contain).radius(4.0),
        ...
        image("https://picsum.photos/seed/f/800/200")
            .width(500.0).height(80.0).fit(ObjectFit::Fill).radius(6.0),

        section_label("ERROR STATE"),
        image("https://this-domain-does-not-exist.invalid/404.png")
            .width(120.0).height(80.0).radius(4.0),
    ].spacing(16.0))
}
